              ...
              {goals.map((goal) => (
                <div key={goal.id} className="bg-white shadow-sm hover:shadow-md transition-all border border-gray-100 rounded-xl p-5 relative flex flex-col">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide shrink-0">
                      {goal.approvalStatus}
                    </span>
                  </div>
                  ...
                  <textarea
                    ...
                    rows="2"
                    className="w-full border border-gray-200 text-[11px] p-2 rounded-lg mb-3 focus:outline-none focus:border-[#5263f9] focus:ring-1 focus:ring-[#5263f9] transition-colors resize-none"
                  ...
                  <div className="mt-auto grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`text-[11px] font-bold uppercase tracking-wide py-2 rounded-lg transition-colors shadow-sm ${
                        loadingId === goal.id
